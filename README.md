...
<a href="http://www.linkedin.com/in/nagella-nagavenkat26">
  <img src="https://img.shields.io/badge/LinkedIn-Connect_Now-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white&labelColor=1e1b4b"/>
</a>
</p>
...
<p>
<img src="https://komarev.com/ghpvc/?username=NagavenkatNagella&label=Profile+Views&color=818cf8&style=for-the-badge&labelColor=1e1b4b"/>
&nbsp;
...
## 🏛️ Design Patent — Government of India
...
║   ┌──────────────────────────────────────────────────┐   ║
║   │                                                  │   ║
║   │  TITLE     : Wind-Powered Wireless Charging      │   ║
...
&nbsp;
<img src="https://img.shields.io/badge/Class-13--02-818cf8?style=for-the-badge&labelColor=1e1b4b"/>
&nbsp;
<img src="https://img.shields.io/badge/Authority-Govt._of_India-f59e0b?style=for-the-badge&labelColor=451a03"/>
&nbsp;
<img src="https://img.shields.io/badge/Issued-19_Jan_2026-ef4444?style=for-the-badge&labelColor=450a0a"/>
</p>
...
| 🏅 | Achievement | Event |
|:--:|:-----------|:-----:|
| 🥇 **Gold** | **1st Prize — Project Showcase** | KARE IEEE RAS Showcase 2.0 |
| 🥈 **Silver** | **2nd Prize — Grand Finale** | KARE IEEE Robotics & Automation Society |
| 🥈 **Silver** | **2nd Prize — Project Expo 2025** | IEEE Computer Society |
| ⭐ **Special** | **Child Scientist — Golden Star Award** | Scientific Innovation (School Level) |
...
<details>
<summary><b>🔽 &nbsp; Click to Explore — 20+ Hardware & IoT Projects</b></summary>
...
|:--:|:----------|:--------------|:--------:|
| 01 | 🌱 **Auto Irrigation + Laser Security** | Soil-moisture irrigation with laser intrusion detection for crop safety | `ESP8266` `Sensors` `Relay` |
| 02 | ❤️ **Digital Stethoscope** | Wi-Fi-enabled live heart/lung waveform web dashboard | `MAX9814` `ESP8266` `LCD` |
| 03 | 🌬️ **Custom VAWT — Patented ⭐** | Vertical Axis Wind Turbine for urban renewable energy harvesting | `Power Electronics` `Patent #474355` |
| 04 | 🚗 **EV Wireless Charging Lane** | Prototype lane for continuous EV wireless charging | `Embedded Coils` `Power Control` |
| 05 | 🤖 **Line Following Robot** | Autonomous path-following bot using IR sensors and motor drivers | `IR Sensors` `Motor Driver` |
| 06 | 🦾 **Obstacle Avoidance Robot** | Dual-mode: autonomous obstacle avoidance + Bluetooth remote control | `Ultrasonic` `HC-05` `Arduino` |
| 07 | 💨 **Air Quality Monitoring System** | Live CO₂/NH₃/pollution data on LCD with ESP8266 cloud logging | `MQ135` `ESP8266` `LCD` |
| 08 | 🤟 **Sign Language → LCD & Mobile** | Flex sensor glove transmitting letters via Bluetooth | `Flex Sensors` `Bluetooth` |
| 09 | ♻️ **Waste Segregation System** | Auto-sorts metal, plastic, and biodegradable waste into bins | `Inductive` `Capacitive` `IR` |
| 10 | 🌡️ **Weather Monitoring System** | Real-time temperature and humidity display via DHT11 | `DHT11` `LCD` |
| 11 | 🏪 **Smart Grocery Level Monitor** | IoT pressure-based stock monitor with email threshold alerts | `Pressure Sensor` `ESP8266` |
| 12 | 🩺 **RFID Medicine Dispenser** | Automated dosage via RFID + Python face detection | `RFID` `Python` `OpenCV` |
| 13 | 🔊 **Acoustic Stress Monitor** | Sound-based stress detection triggers smart hydration | `Audio Analysis` `IoT` |
| 14 | 🏭 **Edge AI — Textile Fault Detection** | ML-based early fault detection and production optimization | `Edge AI` `ML` |
| 15 | 🛡️ **SEGOL — Smart Electronic Guard** | Multi-sensor: motion, GPS, GSM, RFID, accelerometer, Wi-Fi | `GPS` `GSM` `RFID` |
| 16 | ⚡ **Footstep Energy Generation** | Piezoelectric plates converting footstep energy into electricity | `Piezoelectric` `Energy Harvesting` |
| 17 | 🚤 **River & Drain Cleaning Robot** | Semi-autonomous Bluetooth-controlled floating waste collector | `Bluetooth` `Motors` |
| 18 | 🏧 **Plastic Bottle Vending Machine** | Detects bottles via IR/proximity, dispenses recycling coupons | `IR` `Proximity` `Servo` |
| 19 | 💊 **Smart Water Delivery System** | Workplace hydration linked to acoustic stress monitoring | `Voice Analysis` `Relay` |
| 20 | 🏗️ **Smart Electronic Security System** | Cloud-sync security with GSM failover when Wi-Fi unavailable | `GSM` `Wi-Fi` `Cloud` |
...
| 🚀 Project | 📋 Description | 🛠️ Stack |
|:----------:|:--------------|:--------:|
| 🏥 **Hospital Management System** | Patient registration, appointments & billing with full OOP architecture | `Java` · OOP · ArrayList |
| 🎮 **Number Guessing Game** | Swing GUI with gradient animations, progress tracking & replay mode | `Java` · Swing |
| 🤖 **Conversational Q&A Chatbot** | AI-powered chatbot using Generative AI API for dynamic Q&A | `Python` · Gen AI |
| 💬 **LAN Chat Application** | Real-time chat with file sharing, login & client-side message management | `Python` · Sockets |
| 🛒 **NaPariyojana Platform** | Full e-commerce for IoT/Arduino projects with integrated email ordering | `JS` · `HTML` · `CSS` |
...
> ### 📌 Personalized Ayurvedic Medicine Recommendations Using Decision Tree Algorithms and Prakriti Analysis
>
> 🏛️ *IEEE International Conference on Emerging Research in Computing Science — **ICERCS 2024***
>
> <a href="https://ieeexplore.ieee.org/document/10895343?denied=">
>   <img src="https://img.shields.io/badge/IEEE-Xplore-00629B?style=for-the-badge&logo=ieee&logoColor=white&labelColor=001a36"/>
> </a>&nbsp;
> <a href="https://ieeexplore.ieee.org/document/10895343?denied=">
...
> **📌 Bridging the Silence: Real-Time Gesture-to-Speech Sign Language Translation for the Deaf using K-NN Classifier**
...
|:----------|:-------------|:-------:|:------:|
| **B.Tech — CSE (AI & ML)** | Kalasalingam Academy of Research & Education, Tamil Nadu | ![CGPA](https://img.shields.io/badge/CGPA-8.35_/_10-818cf8?style=flat-square&labelColor=1e1b4b) | 2022 – 2026 |
| **Intermediate — MPC** | Narayana Junior College, Tirupathi, A.P. | ![Score](https://img.shields.io/badge/Score-82.7%25-6366f1?style=flat-square&labelColor=1e1b4b) | 2022 |
| **Secondary School** | Model Academy EM School, Renigunta, A.P. | ![Score](https://img.shields.io/badge/Score-96.83%25-a5b4fc?style=flat-square&labelColor=1e1b4b) | 2020 |
...
<p>
<a href="https://drive.google.com/file/d/1Ht-9oIWyyEnRoczgAWKhG1s9q3d62RuU/view?usp=sharing">
  <img src="https://img.shields.io/badge/🤖_Generative_AI-Greeks_for_Greeks-8b5cf6?style=for-the-badge&labelColor=1e1b4b"/>
</a>&nbsp;
<a href="https://drive.google.com/file/d/1Ht-9oIWyyEnRoczgAWKhG1s9q3d62RuU/view?usp=sharing">
  <img src="https://img.shields.io/badge/🔌_Embedded_Systems-Greeks_for_Greeks-6366f1?style=for-the-badge&labelColor=1e1b4b"/>
</a>&nbsp;
<a href="https://drive.google.com/drive/folders/1RxFUpZymnYWJdWnjZDmvDI1s8okXJFWc?usp=sharing">
  <img src="https://img.shields.io/badge/🏆_Hackathon_Certs-View_All-f59e0b?style=for-the-badge&labelColor=1e1b4b"/>
</a>
</p>
<p>
<a href="https://drive.google.com/file/d/1tyB8VRx3zB3aD8xjhKsbFQshmiO_GiRu/view?usp=sharing">
  <img src="https://img.shields.io/badge/🔬_Project_Expo-IEEE_Certificate-22c55e?style=for-the-badge&labelColor=1e1b4b"/>
</a>&nbsp;
<img src="https://img.shields.io/badge/🏛️_Design_Patent-Govt._of_India-ef4444?style=for-the-badge&labelColor=1e1b4b"/>
</p>
...
| ⚡ Intelligent Systems | 🌿 Sustainable Engineering | 🔄 Seamless Integration |
|:---:|:---:|:---:|
| *Build intelligent systems,<br/>not isolated projects.* | *Engineer sustainability,<br/>not temporary solutions.* | *Integrate hardware, software<br/>& UX seamlessly.* |
| `Smart` · `Scalable` · `Connected` | `Green` · `Renewable` · `Future-Ready` | `End-to-End` · `Full-Stack` · `Unified` |

<br/>

> *"Building the bridge between embedded intelligence and real-world impact."*
